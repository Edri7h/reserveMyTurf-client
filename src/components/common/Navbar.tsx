...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-transparent  top-0 z-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center space-x-4">
                  <div className="relative">
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-4 h-4 text-white/80 transition-transform duration-200 ${showDropdown ? "rotate-180" : ""
                          }`}
                      />
                    </button>
          ...
          {/* Mobile Menu */}
          {showMobileMenu  && (
            <div className="absolute top-full  right-0 md:hidden bg-white shadow-xl rounded-xl w-64 mx-4 mt-2 z-50">
                ...
                {!isLoggedIn ? (
                  <div className="flex flex-col items-start space-y-2">
                    <Link to="/login">
                      <Button
                        variant="ghost"
                        className="px-4 py-2 text-sm text-gray-800  hover:bg-gray-100 font-medium"
                      >
                        Login
                      </Button>
                    </Link>
